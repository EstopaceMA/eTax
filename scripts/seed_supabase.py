        ...
        [
            {
                "key": "profile-review",
                "name": "Profile review",
                "description": "Review taxpayer category, TIN status, registration status, and filing cadence before preparing a mock return.",
                "url": None,
                "external": False,
            },
            {
                ...
                "description": "Confirm required profile details and checklist items before starting a mock filing.",
                "url": None,
                "external": False,
            },
            {
                ...
                "description": "Simulate reviewing a return, submitting it, and moving the obligation to filed status.",
                "url": None,
                "external": False,
            },
            {
                ...
                "description": "Practice marking a simulated payment as unpaid, paid, or not required.",
                "url": None,
                "external": False,
            },
        ],
        ...
        [
            {
                ...
                "description": "Review your TIN, RDO, registration status, and filing cadence before preparing a return.",
                "status": "filed",
                "sort_order": 1,
            ...
            },
            {
                ...
                "description": "Gather registration details, income records, expense notes, and prior payment references.",
                "status": "ready",
                "sort_order": 2,
                "handoff_key": None,
            },
            {
                ...
                "description": "Check whether required documents and status fields are complete before starting a mock filing.",
                "status": "ready",
                "sort_order": 3,
            ...
            },
            {
                ...
                "description": "Review the simulated filing details and submit the mock return inside eTax.",
                "status": "draft",
                "sort_order": 4,
            ...
            },
            {
                ...
                "description": "Update your mock filing and payment status so the compliance tracker stays current.",
                "status": "draft",
                "sort_order": 5,
                "handoff_key": None,
            },
        ...
        [
            {
                ...
                "description": "Keep registration details nearby to confirm tax types and RDO for the mock filing.",
                "required": True,
                "status": "complete",
            },
            {
                ...
                "description": "Confirm your TIN and registered address before using the mock filing flow.",
                "required": True,
                "status": "complete",
            },
            {
        ...
        [
            {
                ...
                "description": "Review income records and missing checklist items before starting mock filing.",
                "due_date": "2026-08-15",
                "status": "due_soon",
                "channel": "Mock filing",
            },
            ...
            },
            {
                ...
                "description": "Review whether any profile details should be updated before your mock workflow.",
                "due_date": "2026-09-05",
                "status": "upcoming",
