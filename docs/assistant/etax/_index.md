...
Use these documents as app-specific context for answering questions about how to use eTax. They are written for taxpayers using the app, not for developers.

eTax helps a taxpayer prepare for Philippine tax filing by keeping profile details, document readiness, filing deadlines, uploaded income records, extracted invoice totals, and generated BIR form previews in one workspace.

## Main areas

- Dashboard: view filing readiness, next deadlines, active filing status, and income record totals.
